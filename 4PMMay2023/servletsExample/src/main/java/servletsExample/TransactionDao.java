...
public class TransactionDao extends AbstractDao<Transaction> {
	...
	@Override
	public int save(Transaction t) throws SQLException, ClassNotFoundException {
	...
	@Override
	public Transaction getOne(int id) throws SQLException, ClassNotFoundException {
	...
	@Override
	public int update(Transaction t) throws SQLException, ClassNotFoundException {
