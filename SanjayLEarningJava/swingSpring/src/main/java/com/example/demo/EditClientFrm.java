...
public class EditClientFrm extends JFrame implements ActionListener{
    ...
    public EditClientFrm() throws HeadlessException {
		super();
		// TODO Auto-generated constructor stub
	}

	public EditClientFrm(GraphicsConfiguration gc) {
		super(gc);
		// TODO Auto-generated constructor stub
	}

	public EditClientFrm(String title, GraphicsConfiguration gc) {
		super(title, gc);
		// TODO Auto-generated constructor stub
	}

	public EditClientFrm(String title) throws HeadlessException {
		super(title);
		// TODO Auto-generated constructor stub
	}
