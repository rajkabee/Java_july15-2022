...
public class SearchClientFrm extends JFrame implements ActionListener, Runnable{
	@Autowired
    ClientRepository clientRepo;
    public SearchClientFrm(GraphicsConfiguration gc) {
		super(gc);
		// TODO Auto-generated constructor stub
	}

	public SearchClientFrm(String title, GraphicsConfiguration gc) {
		super(title, gc);
		// TODO Auto-generated constructor stub
	}

	public SearchClientFrm(String title) throws HeadlessException {
		super(title);
		// TODO Auto-generated constructor stub
	}
    ...
    private void btnSearchClick(){
       ...
       // ClientDAO clientDAO = new ClientDAO();
        ...
        listClient = (ArrayList<Client>) clientRepo.findAll();
        listEdit.clear();
       listDelete.clear(); 
    ...
    private void btnDeleteClick(int index){
        ...
        if(dialogResult == JOptionPane.YES_OPTION){
        	...
        	clientRepo.delete(listClient.get(index));
            listClient.remove(index);
